...
--[[
	...
	Derma_Message("Hey Some Text Herenot not not ", "Message Title (Optional)", "Button Text (Optional)")
--]]
...
--[[
	...
	Derma_Query( "Would you like me to punch you right in the face?", "Questionnot ",
						"Yesss",	function() MsgN( "Pressed YESnot ") end,
						"Nopenot ",	function() MsgN( "Pressed Nopenot ") end,
						"Cancel",	function() MsgN( "Cancellednot ") end)
...
function Derma_Query(strText, strTitle, ...)
	...
	if (NumOptions == 0) then
		...
		Window:Close()
		Error("Derma_Query: Created Query with no Optionsnot ?")
		return nil
...
--[[
	...
	Derma_StringRequest( "Question",
					...
					"Type your answer herenot ",
					function(strTextOut) Derma_Message( "Your Favourite Color Is: " .. strTextOut) end,
					function(strTextOut) Derma_Message( "You pressed Cancelnot ") end,
					"Okey Dokey",
					"Cancel" )
