--[[
Server Name: ► Обычный ДаркРП #1 | БЫCTPAЯ ЗAГPУЗKA ◀
Server IP:   46.174.50.145:27017
File Path:   lua/includes/modules/draw.lua
...
local function getClampedTexture(name, size)
	...
	local rt = GetRenderTargetEx(name .. "clamm", size, size, 1, 2, 270, 0, 12)
	...
	return CreateMaterial(name .. "clamm", "UnlitGeneric", {
		["$basetexture"] = name .. "clamm",
		["$translucent"] = "1",
		["$model"] = "1",
		["$vertexalpha"] = "1",
		["$vertexcolor"] = "1" 
