...
--
-- Simple uppercase code point mappings, from https://www.unicode.org/Public/17.0.0/ucd/UnicodeData.txt
--
local upperMap = {
...
--
-- Simple lowercase code point mappings, from https://www.unicode.org/Public/17.0.0/ucd/UnicodeData.txt
--
local lowerMap = {
...
function upper( str )
	...
	return ( string.gsub( str, charpattern, function( c )
		local cp = codepoint( c )
		local up = upperMap[ cp ]
		return up and char( up ) or nil
	end ) )
...
function lower( str )
	...
	return ( string.gsub( str, charpattern, function( c )
		local cp = codepoint( c )
		local lo = lowerMap[ cp ]
		return lo and char( lo ) or nil
	end ) )
