...
-- Half-Life 2 (Weapons)
ADD_WEAPON( "weapon_physcannon", "#HL2_GravityGun",  false )
ADD_WEAPON( "weapon_stunstick", "#HL2_StunBaton",  true )
ADD_WEAPON( "weapon_frag", "#HL2_Grenade",  false )
ADD_WEAPON( "weapon_crossbow", "#HL2_Crossbow",  true )
ADD_WEAPON( "weapon_bugbait", "#HL2_Bugbait",  false )
ADD_WEAPON( "weapon_rpg", "#HL2_RPG",  true )
ADD_WEAPON( "weapon_crowbar", "#HL2_Crowbar",  true )
ADD_WEAPON( "weapon_shotgun", "#HL2_Shotgun",  true )
ADD_WEAPON( "weapon_pistol", "#HL2_Pistol",  true )
ADD_WEAPON( "weapon_slam", "#HL2_SLAM",  false )
ADD_WEAPON( "weapon_smg1", "#HL2_SMG1",  true )
ADD_WEAPON( "weapon_ar2", "#HL2_Pulse_Rifle",  true )
ADD_WEAPON( "weapon_357", "#HL2_357Handgun",  true )
ADD_WEAPON( "weapon_alyxgun", "#HL2_AlyxGun",  true, false )
ADD_WEAPON( "weapon_annabelle", "#HL2_Annabelle",  true, false )
