...
if ( IsMounted( "hl1" ) || IsMounted( "hl1mp" ) ) then
	...
	AddNPC( { Class = "monster_turret", Category = Category, Offset = 0, KeyValues = { orientation = 1 }, NoDrop = true, SpawnFlags = 32 } )
	AddNPC( { Class = "monster_miniturret", Category = Category, Offset = 0, KeyValues = { orientation = 1 }, NoDrop = true, SpawnFlags = 32 } )
