...
local checkList = {}
checkList[ "cheat" ] = { tooltip = "#menubar.cheatstip", func = function() return GetConVar( "sv_cheats" ):GetInt() != 0 end }
checkList[ "cheatSP" ] = { tooltip = "#menubar.cheatstip", func = function() return GetConVar( "sv_cheats" ):GetInt() != 0 or game.SinglePlayer() end }
