...
checkList[ "cheat" ] = { tooltip = "#menubar.cheatstip", func = function() return sv_cheats:GetBool() end }
checkList[ "cheatSP" ] = { tooltip = "#menubar.cheatstip", func = function() return sv_cheats:GetBool() or game.SinglePlayer() end }
