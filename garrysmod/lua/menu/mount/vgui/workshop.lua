...
function PANEL:Paint(w, h)
	...
	DisableClipping( true )
		draw.RoundedBox( 4, -1, -1, w+2, h+2, Color( 0, 0, 0, 255 ) )
	...
	if ( self:GetDrawProgress() ) then
		...
		-- Overall progress
		local off = 0
		local w2 = (w - 64 - 64 - 100)
		local x = 80

		draw.RoundedBox( 4, x+32 + off, 44 + 18, w2, 10, Color( 0, 0, 0, 150 ) )
		draw.RoundedBox( 4, x+33 + off, 45 + 18, w2 * math.Clamp( self.TotalProgress, 0.05, 1 )-2, 8, Color( 255, 255, 255, 200 ) )

		-- Current file Progress
		draw.RoundedBox( 4, x+32, 40, w2, 15, Color( 0, 0, 0, 150 ) )
		draw.RoundedBox( 4, x+33, 41, w2 * math.Clamp( self.Progress, 0.05, 1 )-2, 15-2, Color( 255, 255, 255, 200 ) )
