...
L.equip_help_carry = "Você só pode comprar coisas nas quais você tem algum slot para guardá-las."
...
L.xfer_no_credits = "Você não tem créditos para transferir!"
L.xfer_send       = "Transferir um crédito"
...
L.xfer_no_credits = "Você não tem créditos suficientes para completar a transferência."
L.xfer_success    = "A transferência de créditos para {player} foi bem-sucedida."
L.xfer_received   = "{player} transferiu {num} crédito(s) para você."

-- Radio tab in equipment menu
L.radio_name      = "Rádio"
L.radio_help      = "Clique em um botão para fazer seu Rádio reproduzir tal som."
L.radio_notplaced = "Você deve posicionar o Rádio em algum lugar para poder reproduzir sons nele."
...
L.quick_corpse    = "um cadáver não identificado"
L.quick_corpse_id = "o cadáver de {player}"


--- Body search window
L.search_title  = "Resultado das investigações deste corpo"
L.search_info   = "Informação"
L.search_confirm = "Confirmar morte"
L.search_call   = "Chamar Detetive"

-- Descriptions of pieces of information found
L.search_nick   = "Este é o cadáver de {player}."
...
L.search_disg   = "Ele estava carregando um dispositivo que podia esconder sua identidade."
...
L.search_dmg_tele   = "Parece que a amostra do DNA dele foi embaraçada por causa de emissões de táquion!"
...
-- Scoreboard
L.sb_playing    = "Você está jogando no(a)..."
...
L.set_startpopup_tip = "Quando a rodada começa, um pequeno popup aparece na parte inferior da tela por alguns segundos. Configure aqui por quanto tempo ele é exibido."
...
L.c4_no_disarm    = "Você não pode desarmar o C4 de outro Traidor a menos que ele esteja morto."
L.c4_disarm_warn  = "Um C4 que você plantou foi desarmado."
...
L.defuser_help    = "{primaryfire} desarma um C4 que está na sua mira."

L.defuser_desc    = [[
Instantaneamente desarma um explosivo C4.

Seus usos são ilimitados. Um C4 será mais fácil de
ser notado se você estiver com isto equipado.]]

-- Flare gun
L.flare_name      = "Arma Sinalizadora"
L.flare_desc      = [[
...
Seus usos são ilimitados, porém
o processo de identificação demora alguns segundos.]]

L.binoc_help_pri  = "{primaryfire} identifica um cadáver."
...
L.dna_identify    = "O cadáver deve ser identificado para coletar a amostra de DNA do assassino."
...
L.dna_decayed     = "A amostra de DNA do assassino se deteriorou."
...
do jogador ao qual a amostra de DNA selecionada pertence.
Rastrear alvos distantes consome mais energia.]]

L.dna_menu_scan   = "Rastrear"
L.dna_menu_repeat = "Realizar rastreamentos automaticamente"
...
L.tele_desc       = [[
Teletransporta para um local marcado previamente.
...
L.ammo_ar2altfire = "Munição de Arma Sinalizadora"
...
L.target_unid  = "Cadáver não identificado"
...
L.punch_help   = "Movimentar-se ou pular: soca o objeto. Agachar: sai do objeto."
...
L.spec_help    = "Clique para observar jogadores, ou pressione {usekey} em um objeto para possuí-lo."
...
Seja cauteloso, ou sua traição pode ser descoberta...
...
L.tip6 = "Quando um Traidor morre, todos os Detetives são recompensados com créditos de equipamentos."

L.tip7 = "Quando os Traidores fizerem um progresso significativo matando inocentes, eles serão recompensados com créditos de equipamentos."

L.tip8 = "Traidores e Detetives podem coletar créditos de equipamentos não gastos dos cadáveres de outros Traidores e Detetives."

L.tip9 = "O Poltergeist pode tornar qualquer objeto de física em um projétil mortal. Cada empurrão é acompanhado de uma explosão de energia que fere todos que estejam perto."
...
L.tip12 = "O Scanner de DNA dos Detetives pode ser usado para coletar amostras de DNA de armas e itens. Então, o Detetive pode usar as amostras para descobrir quem usou as armas/itens. Isto é útil quando você consegue coletar uma amostra de um cadáver ou de um C4 desarmado!"

L.tip13 = "Quando você está perto de alguém que você matou, um pouco do seu DNA é deixado no cadáver da vítima. Este DNA pode ser coletado por um Scanner de DNA de um Detetive para encontrar sua localização atual. Depois de esfaquear alguém, é melhor você esconder o cadáver da vítima!"
...
L.tip24 = "Pressione {helpkey} para ver um curto tutorial ou modificar as configurações específicas do TTT. Por exemplo, você pode desabilitar permanentemente estas dicas lá."

L.tip25 = "Quando um Detetive investiga um cadáver, o resultado é disponibilizado para todos no placar ao clicar no nome da pessoa morta."
...
L.tip37 = "No placar, clique no nome de um jogador vivo e então você poderá marcá-lo como 'suspeito' ou 'amigo', entre outras marcações. A marcação será exibida quando você estiver com a mira em cima do jogador marcado."
...
L.tip40 = "Caso esteja escrito 'MODO PRESSA' acima do tempo da rodada, a rodada terá inicialmente apenas alguns minutos, mas a cada morte o tempo disponível aumenta (como capturar um ponto no TF2). Este modo pressiona os Traidores para que eles mantenham as coisas em movimento."
...
L.ev_fall_pushed = "{victim} caiu para sua morte depois de {attacker} empurrá-lo"
...
L.aw_brn3_text  = "queimou todos, mas agora está sem granadas incendiárias! Como ele vai lidar com isto!?"
...
--- 2018-07-24
L.equip_tooltip_main = "Menu de Equipamento"
