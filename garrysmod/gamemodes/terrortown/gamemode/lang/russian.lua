...
L.limit_left       = "Осталось раундов: {num} или {time} мин. до смены карты на {mapname}."
...
L.xfer_received   = "{player} передаёт вам кредиты: {num}."

-- Radio tab in equipment menu
L.radio_name      = "Радио"
L.radio_help      = "Нажмите на кнопку, чтобы воспроизвести выбранный звук."
L.radio_notplaced = "Вам надо поместить радио для воспроизведения звуков."
...
L.radio_button_huge    = "Г.Р.О.М.А.Д.И.Н.А"
...
L.set_cross_opacity   = "Полупрозрачность прицела при прицеливании"
...
-- Health station
L.hstation_name   = "Лечебноволновка"
L.hstation_hint   = "Нажмите [{usekey}], чтобы восстановить здоровье. Заряд: {num}."
L.hstation_broken = "Ваша лечебноволновка уничтожена!"
L.hstation_help   = "{primaryfire}: разместить лечебноволновку."
...
--- Various other text
L.name_kick = "Игрок автоматически исключён за смену ника во время раунда."
...
L.tip15 = "Вы предатель и собираетесь быть снайпером? Попробуйте купить маскировку. Если промажете, убегите в безопасное место, выключите маскировку и никто не будет знать, что именно вы стреляли в них."
...
L.tip21 = "«Лечебноволновка» позволяет раненым игрокам восстановить здоровье. Конечно, этими игроками могут быть и предатели."

L.tip22 = "«Лечебноволновка» собирает образцы ДНК всех, кто ей пользовался. Детективы могут использовать образцы с помощью сканера ДНК, чтобы найти тех, кто ей пользовался."
...
L.aw_hug1_text  = "был в гармонии со своим пулемётом «Г.Р.О.М.А.Д.И.Н.А», умудрившись как-то заставить свои пули убить 4 человек."

L.aw_hug2_title = "Терпеливая пара"
L.aw_hug2_text  = "продолжал стрелять из пулемёта «Г.Р.О.М.А.Д.И.Н.А» и обнаружил, что терпение вознаградило его {num} убийствами."
