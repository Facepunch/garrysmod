...
L.sb_info_help  = "Осмотрите тело этого игрока, чтобы пересмотреть результаты здесь."
...
L.tip27 = "Тела со значком лупы после имени осмотрены детективом, а результаты их осмотра доступны всем игрокам через таблицу счёта."
