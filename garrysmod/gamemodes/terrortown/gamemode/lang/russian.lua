...
L.round_started    = "Раунд началсяnot "
...
L.win_time         = "Время вышлоnot  Предатели повержены."
L.win_traitor      = "Предатели победилиnot "
L.win_innocent     = "Предатели уничтоженыnot "
...
--- Karma
L.karma_dmg_full   = "Ваша карма {amount}, и вы наносите больший урон в этом раундеnot "
L.karma_dmg_other  = "Ваша карма {amount}. Ваш урон понижен на {num}%. Если вы не остановитесь - будете забаненыnot "

--- Body identification messages
L.body_found       = "{finder} нашел тело {victim}. {role}"

-- The {role} in body_found will be replaced by one of the following:
L.body_found_t     = "Он был Предателемnot "
L.body_found_d     = "Он был Детективом."
L.body_found_i     = "Он был Невинным."

L.body_confirm     = "{finder} подтвердил смерть {victim}."

L.body_call        = "{player} позвал Детектива к телу {victim}not "
L.body_call_error  = "Вы должны подтвердить смерть игрока, прежде чем звать Детективаnot "

L.body_burning     = "АЙnot  Это тело горитnot "
L.body_credits     = "Вы нашли {num} кредитов на телеnot "
...
L.disg_not_owned = "У вас уже есть Маскировкаnot "
...
L.radar_not_owned = "У вас уже есть радарnot "
...
L.radar_charging  = "Ваш радар все еще работаетnot "

-- Transfer tab in equipment menu
L.xfer_name       = "Передача"
L.xfer_menutitle  = "Передать кредиты"
L.xfer_no_credits = "У вас нету кредитов для передачиnot "
...
L.intro_help     = "Если вы новичок, нажмите F1 для помощиnot "
...
L.search_role_t = "Он был Предателемnot "
...
L.search_dmg_fall   = "Он упал и разбился... GENIOUSnot ."
...
L.search_dmg_tele   = "Похоже его ДНК была обосрана БОМЖамиnot "
L.search_dmg_car    = "Пока он переходил дорогу, его сбил долбо*б на машине."
L.search_dmg_other  = "Невозможно определить причину смертиnot "

L.search_weapon = "Видимо его убили при помощи {weapon}."
L.search_head   = "Бах и в голову. Нет времени на разговорыnot "
L.search_time   = "Он умер за {time} минут до того, как вы его нашли."
L.search_dna    = "Он умер совсем недавно и на нем еще осталась ДНК убийцыnot  У вас есть {time} чтобы его отсканировать."
...
L.drop_no_room    = "У тебя нет места. Выбрось свое оружиеnot "

L.disg_turned_on  = "Маскировка Включенаnot "
...
L.c4_disarmed     = "Вы успешно разминировали бомбуnot  Так держать."
...
L.c4_disarm_t     = "Вы - Предатель. Перережьте любой провод для деактивации бомбы. Для невинных это не так легкоnot "
L.c4_disarm_owned = "Перережьте провод если хотите разминировать бомбу."
L.c4_disarm_other = "Аккуратнее... Перережьте провод для разминирования. Если вы ошибетесь, она взорветсяnot "
...
L.decoy_broken    = "Ваша приманка уничтоженаnot not "
...
L.hstation_broken = "Ваша Лечебная Станция уничтоженаnot "
...
-- Radio
L.radio_broken    = "Ваше радио уничтоженоnot "
...
L.newton_desc     = [[
Толкайте людей с безопасного расстоянияnot

Ведь это так веселоnot  Но эта
...
предателейnot  Скорострельный, мощный и стильный,
...
L.dna_killer      = "Вы собрали образец ДНК убийцы с телаnot "
L.dna_no_killer   = "ДНК не может быть получена (killer disconnected?)."
L.dna_armed       = "Бомба все еще активированаnot  Сначала разминируйте ееnot "
...
L.tele_no_ground  = "Невозможно телепортироваться, пока вы не стоите на твердой поверхностиnot "
L.tele_no_crouch  = "Невозможно телепортироваться, пока вы сидитеnot "
L.tele_no_mark    = "Локация не отмеченаnot  Отметте локацию перед телепортацией."

L.tele_no_mark_ground = "Невозможно пометить точку телепортации, пока вы не стоите на твердой поверхностиnot "
L.tele_no_mark_crouch = "Невозможно пометить точку телепортации, пока вы сидитеnot "
...
L.punch_malus  = "Ваш хороший счет повысил ПРЫГ-О-МЕТР на {num}not "
...
Оглядывайтесь назад и держитесь с вашими товарищами чтобы выжитьnot ]]

L.info_popup_detective = [[Вы - Детективnot  Штаб выдал вам специальную экипировку чтобы найти предателей.
Используйте их чтобы помочь невиновным выжить, но будьте осторожны:
Предатели будут пытаться убить вас первымиnot

Нажмите {menukey} чтобы получить ваше снаряжениеnot ]]

L.info_popup_traitor_alone = [[Ты - Предатель. У тебя нет товарищей в этом раунде.

Убей всех чтобы выигратьnot
...
L.idle_warning = "Внимание: Возможно вы АФК. Если вы не покажете свою активность вы будете переведены в режим 'Только Наблюдение'not "
...
L.tip10 = "Если вы Предатель или Детектив - следите за красными надписями сверхуnot  Они могут быть важными для вас."

L.tip11 = "За Детектива или Предателя не забудьте тратить ваши кредиты, которые вы могли получить во время раундаnot "

L.tip12 = "ДНК сканер Детективов может собирать ДНк с тел, брошенного оружия или разминированной С4. Эта информация может сильно помочь в расследованииnot "

L.tip13 = "Если вы близко к человеку которого вы убиваете - вы можете оставить свою ДНК на его теле, а Детектив может ее собрать ДНК сканеромnot "

L.tip14 = "Чем дальше Вы от кого-то, кого убиваете, тем быстрее ваш образец ДНК на их теле распадается."

L.tip15 = "Вы Предатель и хотите по снайперить? Включить маскировку и стреляйтеnot  Если вы промахнетесь - то отбегите на безопасное расстояние, выключите маскировку и никто не узнает, что именно ВЫ стреляли."
...
L.ev_win_traitor = "Чертовы предатели победили в раундеnot "
L.ev_win_inno    = "Белые и пушистые невиновные победили в раундеnot "
L.ev_win_time    = "Предатели были слоупоками, и у них кончилось времяnot "
...
L.aw_fst2_text  = "набил первое убийство в раунде убив своего товарища-предателя. Хорошая Работаnot "
...
L.aw_nkt1_title = "Один Готовnot "
L.aw_nkt1_text  = "сумел убить одного невиновного. Клевоnot "
...
L.aw_rfl2_title = "Я тебя вижуnot "
...
L.aw_knf2_title = "Где ты ЭТО взял?not "
...
L.aw_knf4_text  = "убил {num} людей ножом. Не спрашивайте какnot "

L.aw_flg1_title = "Спасите Меня ужеnot "
...
L.aw_brn3_text  = "сжег их всех, но сейчас у него закончились зажигательные гранаты. Как же он будет справлятьсяnot ?"

L.aw_fnd1_title = "Сыщик"
L.aw_fnd1_text  = "нашел {num} тел валяющихся вокруг."

L.aw_fnd2_title = "Поймать их всехnot "
...
L.aw_tod2_title = "Я ненавижу эту игруnot "
