...
L.w = "Как играть в ТТТ в шести шагах"
...
-- C4
L.c4_hint         = "Нажмите {usekey}, чтобы установить/обезвредить."
...
L.c4_disarm_owned = "Перережьте провод, чтобы обезвредить бомбу. Так это ваша бомба, любой провод безопасен."
...
но может быть использована лишь один раз.

Может быть брошен клавишей альтернативного
огня.]]
...
L.dna_identify    = "Тело должно опознано, чтобы собрали образец ДНК убийцы."
...
L.tele_no_crouch  = "Телепортация возможно только в положении стоя!"
...
L.tip3 = "Детективы могут осмотреть тело, чтобы узнать кто отразился в глазах жертвы. Это будет тот, кого она видела перед смертью. Это не значит что он был убийцей, ведь жертва могла быть убита со спины."
...
L.tip11 = "Будучи предателем или детективом, помните, что вы получаете кредиты, если вы и ваши товарищи хорошо выполняете поставленную задачу. Также не забудьте их тратить!"
...
L.report_save_result = "Журнал событий сохранен в:"
...
L.ev_sui         = "{victim} не выдерживает и совершил самоубийство."
