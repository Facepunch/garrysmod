...
<<<<<<< HEAD
L.round_minplayers = "Не достатньо гравців, щоб розпочати новий раунд..."
L.round_voting     = "Відбувається голосування, новий раунд відкладено на {num} секунд..."
L.round_begintime  = "Новий раунд розпочнеться через {num} секунд. Приготовтесь."
=======
...
<<<<<<< HEAD
L.equip_help_cost = "Кожна частина обладнання, яку ви купуєте, коштує 1 кредит."
=======
...
<<<<<<< HEAD
L.equip_custom     = "Додаткове обладнання, додане цим сервером."
=======
...
<<<<<<< HEAD
L.radar_help      = "Результати сканування показуються {num} секунд, після чого Радар буде перезаряджено і його можна буде використати знову."
=======
...
<<<<<<< HEAD
L.xfer_received   = "{player} надав вам {num} кредит."
=======
...
<<<<<<< HEAD
L.intro_help     = "Якщо ви новий гравець, то натисніть F1 задля інструкції!"
=======
...
<<<<<<< HEAD
L.search_c4     = "У кишені ви знайшли повідомлення. Воно затверджує, що вам необхідно обрізати провід {num}, щоб безпечно знешкодити вибухівку."
=======
...
<<<<<<< HEAD
L.search_dmg_burn   = "Пахне як смажений терорист десь поряд..."
...
L.search_head   = "Смертельний постріл – постріл у голову. Навіть немає часу, щоб закричати."
=======
...
<<<<<<< HEAD
L.sb_info_help  = "Знайдіть тіло цього гравця, і ви зможете переглянути результати тут."
...
<<<<<<< HEAD
L.c4_desc         = "Сильна вибухівка з годинниковим механізмом."
=======
...
<<<<<<< HEAD
L.decoy_broken    = "Вашу Приманку зруйновано!"
=======
...
<<<<<<< HEAD
L.hstation_broken = "Вашу Оздоровчу Станцію зруйновано!"
=======
...
пістолетні набої.
<<<<<<< HEAD
Жертви не будуть кричати, коли їх вбиватимуть.]]
=======
...
L.binoc_desc      = [[
<<<<<<< HEAD
Дозволяє бачити та впізнавати тіла
=======
...
<<<<<<< HEAD
L.tele_no_crouch  = "Телепортація неможлива поки ви навсидячки!"
=======
...
<<<<<<< HEAD
L.tip1 = "Зрадники можуть тихо обшукати тіло без підтвердження смерті. Для цього утримуйте {walkkey} і натисніть {usekey} дивлячись на тіло."
...
L.tip3 = "Детективи можуть обшукати тіло, щоб знайти «відбиток вбивці в очах жертви». Цим відбитком буде остання людина, яку бачив мертвий. Це не обов’язково повинен бути вбивця, якщо жертву вбили зі спини."
=======
...
<<<<<<< HEAD
L.tip13 = "Коли ви наближені до людини, яку вбиваєте, частина вашої ДНК залишається на тілі жертви. Цю ДНК можна використати за допомогою сканера ДНК детектива, щоб визначити ваше поточне місцеперебування. Краще сховати тіло після того, як ви когось зарізали!"
=======
...
<<<<<<< HEAD
L.tip25 = "Коли детектив обшукає тіло, результат дослідження стане доступним для всіх гравців через табло рахунку. Для цього натисніть на ім’я померлої людини."
...
L.tip27 = "Тіла з лупою після імені гравця вказують на те, що їх було обшукано детективом. Інформація про обшук доступна всім іншим гравцям через табло рахунку."
=======
...
<<<<<<< HEAD
L.tip37 = "На табло рахунку клацніть ім’я живого гравця, щоб ви могли вибрати для нього тег, наприклад «підозрілий» або «друг». Цей тег з’явиться, коли вони будуть знаходитись під прицілом."
=======
...
<<<<<<< HEAD
L.hilite_players1 = "{numplayers} гравців узяло участь, {numtraitors} з яких були зрадниками"
L.hilite_players2 = "{numplayers} гравців узяло участь, один з них був зрадником"
=======
...
<<<<<<< HEAD
L.aw_all2_text  = "ніс відповідальність за кожне вбивство зрадника в цьому раунді."

L.aw_nkt1_title = "Один є, Бос!"
L.aw_nkt1_text  = "вдалося вбити одного невинного. Молодець!"
=======
...
<<<<<<< HEAD
L.aw_knf1_text  = "вдарив когось ножем в обличчя через Інтернет."
=======
...
<<<<<<< HEAD
L.aw_fnd2_title = "Треба зловити їх усіх"
=======
